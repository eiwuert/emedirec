<html>
	...
	<body>
		<div style="min-height:690px; padding-top:2px">
			<div style="float:left"><img style="width:50px !important" src="<?php echo base_url("resources/theme/defualt/img/bc_logo.png")?>"/></div>
			<center style="color:#F17795 !important;font-size:20px;position: relative;left: -30px;">គ្លីនិកស្បែក ប៊ីស៊ី​ II (សាខាទួលគក)<br>BC Skin Clinic II (TK)</center>
	...
	<body>
			...
			<div style="min-height: 700px;">
				<div style="float:left"><img style="width:50px !important" src="<?php echo base_url("resources/theme/defualt/img/bc_logo.png")?>"/></div>
			<center style="color:#F17795 !important;font-size:15px;position: relative;left: -30px;">គ្លីនិកស្បែក ប៊ីស៊ី​ II (សាខាទួលគក)<br>BC Skin Clinic II (TK)<br>វិក័យប័ត្រ</center>
